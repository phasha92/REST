...
public class FilmMapperTest {
    ...
    public void testToDTO_ValidFilm() {
        ...
        Film film = new Film(1, "Film A", 2020, List.of(new Actor(1, "John Doe", Collections.emptyList())), director);
        ...
        assertEquals("Mr. Smith", dto.directorName());  // Проверка имени режиссера
    }
    ...
    public void testToEntity_ValidDTO() {
        ...
        assertEquals("Mr. Smith", film.getDirector().getName());  // Проверка директора
    }
