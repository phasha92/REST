...
class ActorDAOTest {
    ...
    @Test
    void testGetByIdNonExistentActorReturnsNull() throws SQLException {
        Actor retrievedActor = actorDAO.getById(999);
        assertNull(retrievedActor);
    }

    @Test
    void testGetFilmsByActorId_WithFilms() throws SQLException {
        Actor actor = new Actor();
        actor.setName("Test Actor");
        actorDAO.create(actor);
        try (Connection connection = dbConnectManager.getConnection();
    ...
    @Test
    void testGetFilmsByActorId_NoFilms() throws SQLException {
        Actor actor = new Actor();
    ...
    @Test
    void testGetFilmsByActorId_NonExistentActor() throws SQLException {
